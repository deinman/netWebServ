// Shamelessly borrowed from many programmers better than I am.
// Tried to keep language usage as simple as possible to allow broader use.
...
namespace Extensions
{
    public static class ExtensionMethods
    {
        ...
        public static void ForEachWithIndexOrUntil<T>(this IEnumerable<T> collection, Action<T, int> action,
            Func<T, int, bool> until)
        {
            int n = 0;
        ...
        /// </summary>
        public static void Fire<TEventArgs>(this EventHandler<TEventArgs> theEvent, object sender, TEventArgs e)
